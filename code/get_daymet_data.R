...
download_daymet_ncss(location = c(49, -101, 24, -69),
                      ...
                      param = "tmin", 
                      path = "C:/Users/gdicecco/Desktop/data/daymet/")

nc2tif(path = "C:/Users/gdicecco/Desktop/data/daymet/")

daymet_raster <- stack("C:/Users/gdicecco/Desktop/data/daymet/tmin_monavg_2017_ncss.tif")
...
nc <- nc_open("C:/Users/gdicecco/Desktop/data/daymet/daymet_v3_tmin_2018_na.nc4")
na18 <- brick("C:/Users/gdicecco/Desktop/data/daymet/daymet_v3_tmin_2018_na.nc4", varname = "tmin")
...
writeRaster(spring18_eNA, "C:/Users/gdicecco/Desktop/data/daymet/tmin_spring_2018")

spring18_eNA <- stack("C:/Users/gdicecco/Desktop/data/daymet/tmin_spring_2018")
spring18_points <- data.frame(rasterToPoints(spring18_eNA))
spring18_sf <- st_as_sf(spring18_points, coords = c("x", "y"), crs = "+proj=lcc +lon_0=-100 +lat_0=42.5 +x_0=0 +y_0=0 +lat_1=25 +a=60 +rf=6378137 +lat_2=45")

spring18_transf <- st_transform(spring18_sf, crs = 4326)
